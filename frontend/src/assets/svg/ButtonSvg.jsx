const ButtonSvg = (white, transparent) => (
  <>
    <svg
      ...
      height="44"
      viewBox="0 0 21 44"
      fill={transparent ? "none" : (white ? "white" : "none")}
      stroke={transparent ? "none" : (white ? "white" : "url(#btn-left)")} // mentioned in ButtonGradient.jsx
    >
      <path
        strokeWidth="2"
    ...
    <svg
      ...
      viewBox="0 0 21 44"
      fill={transparent ? "none" : (white ? "white" : "none")}
      stroke={transparent ? "none" : (white ? "white" : "url(#btn-right)")} // mentioned in ButtonGradient.jsx
    >
      <path
        strokeWidth="2"
